...
export const ANIMATION_OFFSET_BY_NAME = ANIMATION_OFFSETS as Record<string, number>;

export const MAINHAND_IMPORT_TYPE_NAMES = new Set(["weapon", "weapon_magic_crystal"]);
